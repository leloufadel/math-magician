...
**[Math_Magicians]** is a simple maths website with features like calculator. It's build on JavaScript React library.
...
- **[Calculate_simple_maths_equation]**
- **[Read_math_related_quote]**
...
```sh
  cd my-folder
  git clone https://github.com/leloufadel/math-magician.git
```
...
Feel free to check the [issues page](https://github.com/leloufadel/math-magician/issues).
